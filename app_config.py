...
AUTHORITY = "https://login.microsoftonline.com/0336464a-c425-408c-a568-15c3416a24b8"  # For multi-tenant app
...
SCOPE = ["User.ReadBasic.All","Mail.ReadBasic", "Mail.Read", "Mail.ReadWrite"]
